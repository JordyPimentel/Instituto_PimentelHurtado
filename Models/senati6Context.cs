...
{
    public partial class senati6Context : DbContext
    {
        public senati6Context()
        {
        }

        public senati6Context(DbContextOptions<senati6Context> options)
            : base(options)
        {
        }
...
//         optionsBuilder.UseSqlServer("server=senati6.database.windows.net; database=senati6; User ID=LuisYTB; Password=gg20loqueñH;");
//    }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Bloque>(entity =>
            {
                entity.HasKey(e => e.IdBloque)
                    .HasName("PK__Bloques__6B063943B95F5FE0");
            ...
            modelBuilder.Entity<Curso>(entity =>
            {
                entity.HasKey(e => e.IdCurso)
                    .HasName("PK__Cursos__DC72196F3CCFCBE3");
            ...
            modelBuilder.Entity<Estudiante>(entity =>
            {
                entity.HasKey(e => e.IdEstudiante)
                    .HasName("PK__Estudian__9B410A89E1D778E8");
            ...
            modelBuilder.Entity<Matricula>(entity =>
            {
                entity.HasKey(e => e.IdMatricula)
                    .HasName("PK__Matricul__230086D77BE53CB7");
            ...
            modelBuilder.Entity<Profesore>(entity =>
            {
                entity.HasKey(e => e.IdProfesor)
                    .HasName("PK__Profesor__4D3751F6F0183323");
            ...
            modelBuilder.Entity<Programa>(entity =>
            {
                entity.HasKey(e => e.IdPrograma)
                    .HasName("PK__Programa__9DB8D16331EF8856");
