...
namespace Instituto.Controllers
{
    ...
    {
        private readonly senati6Context _context;

        public ProfesoresController(senati6Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Profesores != null ? 
                          ...
                          Problem("Entity set 'senati6Context.Profesores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'senati6Context.Profesores'  is null.");
            }
            var profesore = await _context.Profesores.FindAsync(id);
            if (profesore != null)
            {
